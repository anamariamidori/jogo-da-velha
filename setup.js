...
function checaVencedor(){
    ...
    if (checaSequencia(quadrado1, quadrado2, quadrado3)) {
        ...
        alert("O perdedor é: "+ jogador)
        lert("Fim de jogo!! Reinicie.")
        return;
    }
    ...
    if (vencedor === null && quadrado1.innerHTML !== '-' && quadrado2.innerHTML !== '-' && quadrado3.innerHTML !== '-' && quadrado4.innerHTML !== '-' && quadrado5.innerHTML !== '-' && quadrado6.innerHTML !== '-' && quadrado7.innerHTML !== '-' && quadrado8.innerHTML !== '-' && quadrado9.innerHTML !== '-'){
        alert("Fim de jogo!! Jogo deu velha!! Reinicie.")
